...
jeu: jeu.o goban.o intersection.o pion.o menu.o menu.h goban.h intersection.h dessine.h boolean.h libdessine.a
	gcc -g -o jeu menu.o goban.o intersection.o pion.o jeu.o -L. -ldessine -lX11
